		...
		<ul class="nav navbar-nav">
						...
						<ul class="menu">
							<li>
								<!-- start message --> <a href="#">
									<div class="pull-left">
										<img src="/admin_l_t_e/img/user2-160x160.jpg"
			...
			<li class="dropdown user user-menu"><a href="#"
				class="dropdown-toggle" data-toggle="dropdown"> <img
					src="/admin_l_t_e/img/user2-160x160.jpg" class="user-image"
					alt="User Image"> <span class="hidden-xs">Alexander Pierce</span>
			</a>
				<ul class="dropdown-menu">
					<!-- User image -->
					<li class="user-header"><img
						src="/admin_l_t_e/img/user2-160x160.jpg" class="img-circle"
						alt="User Image">
			...
			<?php if( defined('AdminLTE_ControlSideBar') ): ?>
