...
//            $this->Html->css('AdminLTE.iCheck/square/yellow', array('inline' => false));
        ...
        if (!empty($options[ 'color' ])) {
            switch ($options[ 'color' ]) {
                ...
                case 'yellow':
                    ...
                    $this->Html->css('AdminLTE.iCheck/square/' . $color_box, array(
                        'inline' => false
                    ));
                    break;
                case '':
                ...
                case 'black':
                    $color_box = '';
                    $this->Html->css('AdminLTE.iCheck/square/', array(
                        'inline' => false
                    ));
                    break;
                default :
        ...
        $this->_View->append("scriptAddTemplate", "\$('input[id=\"" . $options[ 'id' ] . "\"]').iCheck({checkboxClass: 'icheckbox_square{$color_box}',radioClass: 'iradio_square{$color_box}',increaseArea: '20%'});\n");
