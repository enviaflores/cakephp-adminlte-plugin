...
<body>
    ...
    <input type="hidden" id="cfgFile" value="<?php defined('__CFGFILE__')?__CFGFILE__:"false";?>" />
    <input type="hidden" id="ticket_id" value="<?php defined('__TICKETID__')?__TICKETID__:"false";?>" />
    <input type="hidden" id="lower_case" value="<?php echo $lower_case?"true":"false";?>" />
