...
if (isset($_GET['ticket_id'])) {
    ...
    $_SESSION['RF']['ticket_id'] = $ticket_id;
} else
    if (isset($_SESSION['RF']['ticket_id'])) {
        $ticket_id = $_SESSION['RF']['ticket_id'];
    }
if (empty($ticket_id))
    die('ticket_id doesnt exists');

$__tickets_base_path = realpath(__DIR__ .'/../../tickets/');
if (isset($ticket_id)) {
    if (! is_dir($__tickets_base_path.'/' . $ticket_id . '/media'))
        mkdir($__tickets_base_path.'/' . $ticket_id . '/media', 0777, true);
    if (! is_dir($__tickets_base_path.'/' . $ticket_id . '/thumbs'))
        mkdir($__tickets_base_path.'/' . $ticket_id . '/thumbs', 0777, true);
} else {
    die();
}
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/tickets/' . $ticket_id . '/media/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../tickets/' . $ticket_id . '/media/',
    ...
    |
    */
    'thumbs_base_path' => '../tickets/' . $ticket_id. '/thumbs/',
