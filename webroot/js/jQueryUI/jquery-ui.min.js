...
d.ui.plugin={add:function(a,b,c){var f;a=d.ui[a].prototype;for(f in c)a.plugins[f]=a.plugins[f]||[],a.plugins[f].push([b,c[f]])},call:function(a,b,c,d){if((b=a.plugins[b])&&(d||a.element[0].parentNode&&11!==a.element[0].parentNode.nodeType))for(d=0;b.length>d;d++)a.options[b[d][0]]&&b[d][1].apply(a.element,c)}};var Z=0,W=Array.prototype.slice;d.cleanData=function(a){return function(b){var c,f,e;for(e=0;null!=(f=b[e]);e++)try{(c=d._data(f,"events"))&&c.remove&&d(f).triggerHandler("remove")}catch(g){}a(b)}}(d.cleanData);
...
a._init()):d.data(this,c,new b(f,this))})),h}};d.Widget=function(){};d.Widget._childConstructors=[];d.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"<div>",options:{disabled:!1,create:null},_createWidget:function(a,b){b=d(b||this.defaultElement||this)[0];this.element=d(b);this.uuid=Z++;this.eventNamespace="."+this.widgetName+this.uuid;this.bindings=d();this.hoverable=d();this.focusable=d();b!==this&&(d.data(b,this.widgetFullName,this),this._on(!0,this.element,{remove:function(a){a.target===
...
m=/[\+\-]\d+(\.[\d]+)?%?/,p=/^\w+/,n=/%$/,q=d.fn.position;d.position={scrollbarWidth:function(){if(void 0!==c)return c;var a,b,f=d("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),e=f.children()[0];return d("body").append(f),a=e.offsetWidth,f.css("overflow","scroll"),b=e.offsetWidth,a===b&&(b=f[0].clientWidth),f.remove(),c=a-b},getScrollInfo:function(a){var b=a.isWindow||a.isDocument?"":a.element.css("overflow-x"),
...
a.outerWidth(),height:b||c?a.height():a.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return q.apply(this,arguments);c=d.extend({},c);var r,s,u,z,n,A,v=d(c.of),D=d.position.getWithinInfo(c.within),x=d.position.getScrollInfo(D),J=(c.collision||"flip").split(" "),L={};return A=b(v),v[0].preventDefault&&(c.at="left top"),s=A.width,u=A.height,z=A.offset,n=d.extend({},z),d.each(["my","at"],function(){var a,b,d=(c[this]||"").split(" ");1===d.length&&(d=k.test(d[0])?d.concat(["center"]):l.test(d[0])?
["center"].concat(d):["center","center"]);d[0]=k.test(d[0])?d[0]:"center";d[1]=l.test(d[1])?d[1]:"center";a=m.exec(d[0]);b=m.exec(d[1]);L[this]=[a?a[0]:0,b?b[0]:0];c[this]=[p.exec(d[0])[0],p.exec(d[1])[0]]}),1===J.length&&(J[1]=J[0]),"right"===c.at[0]?n.left+=s:"center"===c.at[0]&&(n.left+=s/2),"bottom"===c.at[1]?n.top+=u:"center"===c.at[1]&&(n.top+=u/2),r=a(L.at,s,u),n.left+=r[0],n.top+=r[1],this.each(function(){var b,l,k=d(this),m=k.outerWidth(),p=k.outerHeight(),q=parseInt(d.css(this,"marginLeft"),
10)||0,A=parseInt(d.css(this,"marginTop"),10)||0,C=m+q+(parseInt(d.css(this,"marginRight"),10)||0)+x.width,F=p+A+(parseInt(d.css(this,"marginBottom"),10)||0)+x.height,w=d.extend({},n),G=a(L.my,k.outerWidth(),k.outerHeight());"right"===c.my[0]?w.left-=m:"center"===c.my[0]&&(w.left-=m/2);"bottom"===c.my[1]?w.top-=p:"center"===c.my[1]&&(w.top-=p/2);w.left+=G[0];w.top+=G[1];f||(w.left=h(w.left),w.top=h(w.top));b={marginLeft:q,marginTop:A};d.each(["left","top"],function(a,f){d.ui.position[J[a]]&&d.ui.position[J[a]][f](w,
{targetWidth:s,targetHeight:u,elemWidth:m,elemHeight:p,collisionPosition:b,collisionWidth:C,collisionHeight:F,offset:[r[0]+G[0],r[1]+G[1]],my:c.my,at:c.at,within:D,elem:k})});c.using&&(l=function(a){var b=z.left-w.left,d=b+s-m,f=z.top-w.top,h=f+u-p,l={target:{element:v,left:z.left,top:z.top,width:s,height:u},element:{element:k,left:w.left,top:w.top,width:m,height:p},horizontal:0>d?"left":0<b?"right":"center",vertical:0>h?"top":0<f?"bottom":"middle"};m>s&&s>g(b+d)&&(l.horizontal="center");p>u&&u>g(f+
h)&&(l.vertical="middle");l.important=e(g(b),g(d))>e(g(f),g(h))?"horizontal":"vertical";c.using.call(this,a,l)});k.offset(d.extend(w,{using:l}))})};d.ui.position={fit:{left:function(a,b){var c,d=b.within,f=d.isWindow?d.scrollLeft:d.offset.left,d=d.width,g=a.left-b.collisionPosition.marginLeft,h=f-g,l=g+b.collisionWidth-d-f;b.collisionWidth>d?0<h&&0>=l?(c=a.left+h+b.collisionWidth-d-f,a.left+=h-c):a.left=0<l&&0>=h?f:h>l?f+d-b.collisionWidth:f:0<h?a.left+=h:0<l?a.left-=l:a.left=e(a.left-g,a.left)},
top:function(a,b){var c,d=b.within,d=d.isWindow?d.scrollTop:d.offset.top,f=b.within.height,g=a.top-b.collisionPosition.marginTop,h=d-g,l=g+b.collisionHeight-f-d;b.collisionHeight>f?0<h&&0>=l?(c=a.top+h+b.collisionHeight-f-d,a.top+=h-c):a.top=0<l&&0>=h?d:h>l?d+f-b.collisionHeight:d:0<h?a.top+=h:0<l?a.top-=l:a.top=e(a.top-g,a.top)}},flip:{left:function(a,b){var c,d,f=b.within,e=f.offset.left+f.scrollLeft,h=f.width,f=f.isWindow?f.scrollLeft:f.offset.left,l=a.left-b.collisionPosition.marginLeft,k=l-f,
l=l+b.collisionWidth-h-f,m="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,n="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,p=-2*b.offset[0];0>k?(c=a.left+m+n+p+b.collisionWidth-h-e,(0>c||g(k)>c)&&(a.left+=m+n+p)):0<l&&(d=a.left-b.collisionPosition.marginLeft+m+n+p-f,(0<d||l>g(d))&&(a.left+=m+n+p))},top:function(a,b){var c,d,f=b.within,e=f.offset.top+f.scrollTop,h=f.height,f=f.isWindow?f.scrollTop:f.offset.top,l=a.top-b.collisionPosition.marginTop,k=l-f,l=l+b.collisionHeight-
h-f,m="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,n="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,p=-2*b.offset[1];0>k?(d=a.top+m+n+p+b.collisionHeight-h-e,(0>d||g(k)>d)&&(a.top+=m+n+p)):0<l&&(c=a.top-b.collisionPosition.marginTop+m+n+p-f,(0<c||l>g(c))&&(a.top+=m+n+p))}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,arguments);d.ui.position.fit.left.apply(this,arguments)},top:function(){d.ui.position.flip.top.apply(this,arguments);d.ui.position.fit.top.apply(this,
arguments)}}};(function(){var a,b,c,e,g=document.getElementsByTagName("body")[0];c=document.createElement("div");a=document.createElement(g?"div":"body");b={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};g&&d.extend(b,{position:"absolute",left:"-1000px",top:"-1000px"});for(e in b)a.style[e]=b[e];a.appendChild(c);b=g||document.documentElement;b.insertBefore(a,b.firstChild);c.style.cssText="position: absolute; left: 10.7432222px;";c=d(c).offset().left;f=10<c&&11>c;a.innerHTML=
"";b.removeChild(a)})()})();d.ui.position;d.widget("ui.accordion",{version:"1.11.4",options:{active:0,animate:{},collapsible:!1,event:"click",header:"> li > :first-child,> :not(li):even",heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},hideProps:{borderTopWidth:"hide",borderBottomWidth:"hide",paddingTop:"hide",paddingBottom:"hide",height:"hide"},showProps:{borderTopWidth:"show",borderBottomWidth:"show",paddingTop:"show",
...
this.options.messages.noResults,this.liveRegion.children().hide(),d("<div>").text(b).appendTo(this.liveRegion))}});d.ui.autocomplete;var Q,$=function(){var a=d(this);setTimeout(function(){a.find(":ui-button").button("refresh")},1)},X=function(a){var b=a.name,c=a.form,f=d([]);return b&&(b=b.replace(/'/g,"\\'"),f=c?d(c).find("[name='"+b+"'][type=radio]"):d("[name='"+b+"'][type=radio]",a.ownerDocument).filter(function(){return!this.form})),f};d.widget("ui.button",{version:"1.11.4",defaultElement:"<button>",
options:{disabled:null,text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset"+this.eventNamespace).bind("reset"+this.eventNamespace,$);"boolean"!=typeof this.options.disabled?this.options.disabled=!!this.element.prop("disabled"):this.element.prop("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var a=this,b=this.options,c="checkbox"===this.type||"radio"===this.type,f=c?"":
...
a.buttonElement.attr("aria-pressed","true");var c=a.element[0];X(c).not(c).map(function(){return d(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown"+this.eventNamespace,function(){return b.disabled?!1:(d(this).addClass("ui-state-active"),Q=this,a.document.one("mouseup",function(){Q=null}),void 0)}).bind("mouseup"+this.eventNamespace,function(){return b.disabled?!1:(d(this).removeClass("ui-state-active"),void 0)}).bind("keydown"+
...
e.push("ui-button-text-icon"+(f?"s":c.primary?"-primary":"-secondary")),c.primary&&a.prepend("<span class='ui-button-icon-primary ui-icon "+c.primary+"'></span>"),c.secondary&&a.append("<span class='ui-button-icon-secondary ui-icon "+c.secondary+"'></span>"),this.options.text||(e.push(f?"ui-button-icons-only":"ui-button-icon-only"),this.hasTitle||a.attr("title",d.trim(b)))):e.push("ui-button-text-only");a.addClass(e.join(" "))}});d.widget("ui.buttonset",{version:"1.11.4",options:{items:"button, input[type=button], input[type=submit], input[type=reset], input[type=checkbox], input[type=radio], a, :data(ui-button)"},
...
"ui-corner-right":"ui-corner-left").end().filter(":last").addClass(a?"ui-corner-left":"ui-corner-right").end().end()},_destroy:function(){this.element.removeClass("ui-buttonset");this.buttons.map(function(){return d(this).button("widget")[0]}).removeClass("ui-corner-left ui-corner-right").end().button("destroy")}});d.ui.button;d.extend(d.ui,{datepicker:{version:"1.11.4"}});var C;d.extend(T.prototype,{markerClassName:"hasDatepicker",maxRows:4,_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){return K(this._defaults,
...
d=c=0;a.length>e;e++)a[e].length>c&&(c=a[e].length,d=e);return d},g.setMonth(b(this._get(a,h.match(/MM/)?"monthNames":"monthNamesShort"))),g.setDate(b(this._get(a,h.match(/DD/)?"dayNames":"dayNamesShort"))+20-g.getDay()));a.input.attr("size",this._formatDate(a,g).length)}},_inlineDatepicker:function(a,b){var c=d(a);c.hasClass(this.markerClassName)||(c.addClass(this.markerClassName).append(b.dpDiv),d.data(a,"datepicker",b),this._setDate(b,this._getDefaultDate(b),!0),this._updateDatepicker(b),this._updateAlternate(b),
b.settings.disabled&&this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,c,f,e){var g,h,k,l,m;a=this._dialogInst;return a||(this.uuid+=1,g="dp"+this.uuid,this._dialogInput=d("<input type='text' id='"+g+"' style='position: absolute; top: -100px; width: 0px;'/>"),this._dialogInput.keydown(this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a)),K(a.settings,
...
typeof b?"defaults"===b?d.extend({},d.datepicker._defaults):k?"all"===b?d.extend({},k.settings):this._get(k,b):null:(f=b||{},"string"==typeof b&&(f={},f[b]=c),k&&(this._curInst===k&&this._hideDatepicker(),e=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(k,"min"),h=this._getMinMaxDate(k,"max"),K(k.settings,f),null!==g&&void 0!==f.dateFormat&&void 0===f.minDate&&(k.settings.minDate=this._formatDate(k,g)),null!==h&&void 0!==f.dateFormat&&void 0===f.maxDate&&(k.settings.maxDate=this._formatDate(k,
...
c.apply(a,[a,b]):{};!1!==c&&(K(b.settings,c),b.lastVal=null,d.datepicker._lastInput=a,d.datepicker._setDateFromField(b),d.datepicker._inDialog&&(a.value=""),d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight),f=!1,d(a).parents().each(function(){return f|="fixed"===d(this).css("position"),!f}),e={left:d.datepicker._pos[0],top:d.datepicker._pos[1]},d.datepicker._pos=null,b.dpDiv.empty(),b.dpDiv.css({position:"absolute",display:"block",top:"-1000px"}),
...
d.datepicker._curInst=b))}},_updateDatepicker:function(a){this.maxRows=4;C=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);var b,c=this._getNumberOfMonths(a),f=c[1],e=a.dpDiv.find("."+this._dayOverClass+" a");0<e.length&&V.apply(e.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<f&&a.dpDiv.addClass("ui-datepicker-multi-"+f).css("width",17*f+"em");a.dpDiv[(1!==c[0]||1!==c[1]?"add":"remove")+"Class"]("ui-datepicker-multi");
...
c){if(null==a||null==b)throw"Invalid arguments";if(b="object"==typeof b?""+b:b+"",""===b)return null;var f,e,g,h,k=0,l=(c?c.shortYearCutoff:null)||this._defaults.shortYearCutoff,l="string"!=typeof l?l:(new Date).getFullYear()%100+parseInt(l,10),m=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,p=(c?c.dayNames:null)||this._defaults.dayNames,n=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var q=-1,t=-1,r=-1,s=-1,u=!1,z=function(b){b=
a.length>f+1&&a.charAt(f+1)===b;return b&&f++,b},B=function(a){var c=z(a),c="@"===a?14:"!"===a?20:"y"===a&&c?4:"o"===a?3:2;a=RegExp("^\\d{"+("y"===a?c:1)+","+c+"}");a=b.substring(k).match(a);if(!a)throw"Missing number at position "+k;return k+=a[0].length,parseInt(a[0],10)},A=function(a,c,f){var e=-1;a=d.map(z(a)?f:c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});if(d.each(a,function(a,c){var d=c[1];return b.substr(k,d.length).toLowerCase()===d.toLowerCase()?(e=
c[0],k+=d.length,!1):void 0}),-1!==e)return e+1;throw"Unknown name at position "+k;},v=function(){if(b.charAt(k)!==a.charAt(f))throw"Unexpected literal at position "+k;k++};for(f=0;a.length>f;f++)if(u)"'"!==a.charAt(f)||z("'")?v():u=!1;else switch(a.charAt(f)){case "d":r=B("d");break;case "D":A("D",m,p);break;case "o":s=B("o");break;case "m":t=B("m");break;case "M":t=A("M",n,c);break;case "y":q=B("y");break;case "@":h=new Date(B("@"));q=h.getFullYear();t=h.getMonth()+1;r=h.getDate();break;case "!":h=
new Date((B("!")-this._ticksTo1970)/1E4);q=h.getFullYear();t=h.getMonth()+1;r=h.getDate();break;case "'":z("'")?v():u=!0;break;default:v()}if(b.length>k&&(g=b.substr(k),!/^\s+/.test(g)))throw"Extra/unparsed characters found in date: "+g;if(-1===q?q=(new Date).getFullYear():100>q&&(q+=(new Date).getFullYear()-(new Date).getFullYear()%100+(l>=q?0:-100)),-1<s)for(t=1,r=s;!(e=this._getDaysInMonth(q,t-1),e>=r);)t++,r-=e;if(h=this._daylightSavingAdjust(new Date(q,t-1,r)),h.getFullYear()!==q||h.getMonth()+
...
c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var k=function(b){b=a.length>d+1&&a.charAt(d+1)===b;return b&&d++,b},l=function(a,b,c){b=""+b;if(k(a))for(;c>b.length;)b="0"+b;return b},m=function(a,b,c,d){return k(a)?d[b]:c[b]},p="",n=!1;if(b)for(d=0;a.length>d;d++)if(n)"'"!==a.charAt(d)||k("'")?p+=a.charAt(d):n=!1;else switch(a.charAt(d)){case "d":p+=l("d",b.getDate(),2);break;case "D":p+=m("D",b.getDay(),e,g);break;case "o":p+=l("o",Math.round(((new Date(b.getFullYear(),
...
var I=this._getNumberOfMonths(a),y=this._get(a,"showCurrentAtPos");e=this._get(a,"stepMonths");var F=1!==I[0]||1!==I[1],K=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),w=this._getMinMaxDate(a,"min"),G=this._getMinMaxDate(a,"max"),y=a.drawMonth-y,E=a.drawYear;if(0>y&&(y+=12,E--),G)for(b=this._daylightSavingAdjust(new Date(G.getFullYear(),G.getMonth()-I[0]*I[1]+1,G.getDate())),b=w&&w>b?w:b;this._daylightSavingAdjust(new Date(E,y,1))>
...
v="",F){if(v+="<div class='ui-datepicker-group",1<I[1])switch(B){case 0:v+=" ui-datepicker-group-first";s=" ui-corner-"+(H?"right":"left");break;case I[1]-1:v+=" ui-datepicker-group-last";s=" ui-corner-"+(H?"left":"right");break;default:v+=" ui-datepicker-group-middle",s=""}v+="'>"}v+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+s+"'>"+(/all|left/.test(s)&&0===u?H?d:b:"")+(/all|right/.test(s)&&0===u?H?b:d:"")+this._generateMonthYearHeader(a,y,E,w,G,0<u||0<B,l,m)+"</div><table class='ui-datepicker-calendar'><thead><tr>";
D=e?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(s=0;7>s;s++)x=(s+g)%7,D+="<th scope='col'"+(5<=(s+g+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+c[x]+"'>"+k[x]+"</span></th>";v+=D+"</tr></thead><tbody>";D=this._getDaysInMonth(E,y);E===a.selectedYear&&y===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,D));s=(this._getFirstDayOfMonth(E,y)-g+7)%7;D=Math.ceil((s+D)/7);this.maxRows=D=F?this.maxRows>D?this.maxRows:D:D;x=this._daylightSavingAdjust(new Date(E,
y,1-s));for(J=0;D>J;J++){v+="<tr>";L=e?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(x)+"</td>":"";for(s=0;7>s;s++)N=p?p.apply(a.input?a.input[0]:null,[x]):[!0,""],P=(M=x.getMonth()!==y)&&!q||!N[0]||w&&w>x||G&&x>G,L+="<td class='"+(5<=(s+g+6)%7?" ui-datepicker-week-end":"")+(M?" ui-datepicker-other-month":"")+(x.getTime()===A.getTime()&&y===a.selectedMonth&&a._keyEvent||t.getTime()===x.getTime()&&t.getTime()===A.getTime()?" "+this._dayOverClass:"")+(P?" "+this._unselectableClass+
" ui-state-disabled":"")+(M&&!n?"":" "+N[1]+(x.getTime()===K.getTime()?" "+this._currentClass:"")+(x.getTime()===C.getTime()?" ui-datepicker-today":""))+"'"+(M&&!n||!N[2]?"":" title='"+N[2].replace(/'/g,"&#39;")+"'")+(P?"":" data-handler='selectDay' data-event='click' data-month='"+x.getMonth()+"' data-year='"+x.getFullYear()+"'")+">"+(M&&!n?"&#xa0;":P?"<span class='ui-state-default'>"+x.getDate()+"</span>":"<a class='ui-state-default"+(x.getTime()===C.getTime()?" ui-state-highlight":"")+(x.getTime()===
K.getTime()?" ui-state-active":"")+(M?" ui-priority-secondary":"")+"' href='#'>"+x.getDate()+"</a>")+"</td>",x.setDate(x.getDate()+1),x=this._daylightSavingAdjust(x);v+=L+"</tr>"}y++;11<y&&(y=0,E++);v+="</tbody></table>"+(F?"</div>"+(0<I[0]&&B===I[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");z+=v}r+=z}return r+=h,a._keyEvent=!1,r},_generateMonthYearHeader:function(a,b,c,d,e,g,h,k){var l,m,p,n=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),t=this._get(a,"showMonthAfterYear"),
r="<div class='ui-datepicker-title'>",s="";if(g||!n)s+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;l=e&&e.getFullYear()===c;s+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(m=0;12>m;m++)(!h||m>=d.getMonth())&&(!l||e.getMonth()>=m)&&(s+="<option value='"+m+"'"+(m===b?" selected='selected'":"")+">"+k[m]+"</option>");s+="</select>"}if(t||(r+=s+(!g&&n&&q?"":"&#xa0;")),!a.yearshtml)if(a.yearshtml="",g||!q)r+="<span class='ui-datepicker-year'>"+
...
"")+">"+b+"</option>";a.yearshtml+="</select>";r+=a.yearshtml;a.yearshtml=null}return r+=this._get(a,"yearSuffix"),t&&(r+=(!g&&n&&q?"":"&#xa0;")+s),r+="</div>"},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"===c?b:0),e=a.drawMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,e))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,e,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();"M"!==
...
a),this._normalizeRightBottom(),this._mouseDrag(a,!0),d.ui.ddmanager&&d.ui.ddmanager.dragStart(this,a),!0)},_refreshOffsets:function(a){this.offset={top:this.positionAbs.top-this.margins.top,left:this.positionAbs.left-this.margins.left,scroll:!1,parent:this._getParentOffset(),relative:this._getRelativeOffset()};this.offset.click={left:a.pageX-this.offset.left,top:a.pageY-this.offset.top}},_mouseDrag:function(a,b){if(this.hasFixedAncestor&&(this.offset.parent=this._getParentOffset()),this.position=
this._generatePosition(a,!0),this.positionAbs=this._convertPositionTo("absolute"),!b){var c=this._uiHash();if(!1===this._trigger("drag",a,c))return this._mouseUp({}),!1;this.position=c.position}return this.helper[0].style.left=this.position.left+"px",this.helper[0].style.top=this.position.top+"px",d.ui.ddmanager&&d.ui.ddmanager.drag(this,a),!1},_mouseStop:function(a){var b=this,c=!1;return d.ui.ddmanager&&!this.options.dropBehaviour&&(c=d.ui.ddmanager.drop(this,a)),this.dropped&&(c=this.dropped,this.dropped=
!1),"invalid"===this.options.revert&&!c||"valid"===this.options.revert&&c||!0===this.options.revert||d.isFunction(this.options.revert)&&this.options.revert.call(this.element,c)?d(this.helper).animate(this.originalPosition,parseInt(this.options.revertDuration,10),function(){!1!==b._trigger("stop",a)&&b._clear()}):!1!==this._trigger("stop",a)&&this._clear(),!1},_mouseUp:function(a){return this._unblockFrames(),d.ui.ddmanager&&d.ui.ddmanager.dragStop(this,a),this.handleElement.is(a.target)&&this.element.focus(),
...
(this.element[0].style.position="relative")},_adjustOffsetFromHelper:function(a){"string"==typeof a&&(a=a.split(" "));d.isArray(a)&&(a={left:+a[0],top:+a[1]||0});"left"in a&&(this.offset.click.left=a.left+this.margins.left);"right"in a&&(this.offset.click.left=this.helperProportions.width-a.right+this.margins.left);"top"in a&&(this.offset.click.top=a.top+this.margins.top);"bottom"in a&&(this.offset.click.top=this.helperProportions.height-a.bottom+this.margins.top)},_isRootNode:function(a){return/(html|body)/i.test(a.tagName)||
a===this.document[0]},_getParentOffset:function(){var a=this.offsetParent.offset(),b=this.document[0];return"absolute"===this.cssPosition&&this.scrollParent[0]!==b&&d.contains(this.scrollParent[0],this.offsetParent[0])&&(a.left+=this.scrollParent.scrollLeft(),a.top+=this.scrollParent.scrollTop()),this._isRootNode(this.offsetParent[0])&&(a={top:0,left:0}),{top:a.top+(parseInt(this.offsetParent.css("borderTopWidth"),10)||0),left:a.left+(parseInt(this.offsetParent.css("borderLeftWidth"),10)||0)}},_getRelativeOffset:function(){if("relative"!==
...
c.offset.click;e._intersectsWith(e.containerCache)&&(f=!0,d.each(c.sortables,function(){return this.positionAbs=c.positionAbs,this.helperProportions=c.helperProportions,this.offset.click=c.offset.click,this!==e&&this._intersectsWith(this.containerCache)&&d.contains(e.element[0],this.element[0])&&(f=!1),f}));f?(e.isOver||(e.isOver=1,c._parent=b.helper.parent(),e.currentItem=b.helper.appendTo(e.element).data("ui-sortable-item",!0),e.options._helper=e.options.helper,e.options.helper=function(){return b.helper[0]},
a.target=e.currentItem[0],e._mouseCapture(a,!0),e._mouseStart(a,!0,!0),e.offset.click.top=c.offset.click.top,e.offset.click.left=c.offset.click.left,e.offset.parent.left-=c.offset.parent.left-e.offset.parent.left,e.offset.parent.top-=c.offset.parent.top-e.offset.parent.top,c._trigger("toSortable",a),c.dropped=e.element,d.each(c.sortables,function(){this.refreshPositions()}),c.currentItem=c.element,e.fromOutside=c),e.currentItem&&(e._mouseDrag(a),b.position=e.position)):e.isOver&&(e.isOver=0,e.cancelHelperRemoval=
...
/textarea/i.test(b[0].nodeName),f=c&&this._hasScroll(b[0],"left")?0:this.sizeDiff.height,e=c?0:this.sizeDiff.width,g={width:this.helper.width()-e,height:this.helper.height()-f},h=parseInt(this.element.css("left"),10)+(this.position.left-this.originalPosition.left)||null,k=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null,l.animate||this.element.css(d.extend(g,{top:k,left:h})),this.helper.height(this.size.height),this.helper.width(this.size.width),this._helper&&
!l.animate&&this._proportionallyResize()),d("body").css("cursor","auto"),this.element.removeClass("ui-resizable-resizing"),this._propagate("stop",a),this._helper&&this.helper.remove(),!1},_updatePrevProperties:function(){this.prevPosition={top:this.position.top,left:this.position.left};this.prevSize={width:this.size.width,height:this.size.height}},_applyChanges:function(){var a={};return this.position.top!==this.prevPosition.top&&(a.top=this.position.top+"px"),this.position.left!==this.prevPosition.left&&
...
this.uiButtonSet.empty(),d.isEmptyObject(b)||d.isArray(b)&&!b.length?(this.uiDialog.removeClass("ui-dialog-buttons"),void 0):(d.each(b,function(b,f){var e,g;f=d.isFunction(f)?{click:f,text:b}:f;f=d.extend({type:"button"},f);e=f.click;f.click=function(){e.apply(a.element[0],arguments)};g={icons:f.icons,text:f.showText};delete f.icons;delete f.showText;d("<button></button>",f).button(g).appendTo(a.uiButtonSet)}),this.uiDialog.addClass("ui-dialog-buttons"),this.uiDialogButtonPane.appendTo(this.uiDialog),
...
g?"isover":"isout"]=!1,this["isover"===g?"_over":"_out"].call(this,b),c&&"isout"===g&&(c.isout=!1,c.isover=!0,c._over.call(c,b)))}})},dragStop:function(a,b){a.element.parentsUntil("body").unbind("scroll.droppable");a.options.refreshPositions||d.ui.ddmanager.prepareOffsets(a,b)}};d.ui.droppable;d.effects={effect:{}};(function(a,b){function c(a,b,c){var d=p[b.type]||{};return null==a?c||!b.def?null:b.def:(a=d.floor?~~a:parseFloat(a),isNaN(a)?b.def:d.mod?(a+d.mod)%d.mod:0>a?0:a>d.max?d.max:a)}function d(c){var f=
l(),e=f._rgba=[];return c=c.toLowerCase(),t(k,function(a,d){var g,h=d.re.exec(c),h=h&&d.parse(h),l=d.space||"rgba";return h?(g=f[l](h),f[m[l].cache]=g[m[l].cache],e=f._rgba=g._rgba,!1):b}),e.length?("0,0,0,0"===e.join()&&a.extend(e,g.transparent),f):g[c]}function e(a,b,c){return c=(c+1)%1,1>6*c?a+6*(b-a)*c:1>2*c?b:2>3*c?a+6*(b-a)*(2/3-c):a}var g,h=/^([\-+])=\s*(\d+\.?\d*)/,k=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[a[1],a[2],
a[3],a[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[2.55*a[1],2.55*a[2],2.55*a[3],a[4]]}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,parse:function(a){return[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]}},{re:/#([a-f0-9])([a-f0-9])([a-f0-9])/,parse:function(a){return[parseInt(a[1]+a[1],16),parseInt(a[2]+a[2],16),parseInt(a[3]+a[3],16)]}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,
space:"hsla",parse:function(a){return[a[1],a[2]/100,a[3]/100,a[4]]}}],l=a.Color=function(b,c,d,f){return new a.Color.fn.parse(b,c,d,f)},m={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},p={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},n=l.support={},q=a("<p>")[0],t=a.each;q.style.cssText="background-color:rgba(1,1,1,.5)";n.rgba=
-1<q.style.backgroundColor.indexOf("rgba");t(m,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});l.fn=a.extend(l.prototype,{parse:function(e,h,k,n){if(e===b)return this._rgba=[null,null,null,null],this;(e.jquery||e.nodeType)&&(e=a(e).css(h),h=b);var p=this,q=a.type(e),v=this._rgba=[];return h!==b&&(e=[e,h,k,n],q="array"),"string"===q?this.parse(d(e)||g._default):"array"===q?(t(m.rgba.props,function(a,b){v[b.idx]=c(e[b.idx],b)}),this):"object"===q?(e instanceof l?t(m,function(a,
b){e[b.cache]&&(p[b.cache]=e[b.cache].slice())}):t(m,function(b,d){var f=d.cache;t(d.props,function(a,b){if(!p[f]&&d.to){if("alpha"===a||null==e[a])return;p[f]=d.to(p._rgba)}p[f][b.idx]=c(e[a],b,!0)});p[f]&&0>a.inArray(null,p[f].slice(0,3))&&(p[f][3]=1,d.from&&(p._rgba=d.from(p[f])))}),this):b},is:function(a){var c=l(a),d=!0,f=this;return t(m,function(a,e){var g,h=c[e.cache];return h&&(g=f[e.cache]||e.to&&e.to(f._rgba)||[],t(e.props,function(a,c){return null!=h[c.idx]?d=h[c.idx]===g[c.idx]:b})),d}),
d},_space:function(){var a=[],b=this;return t(m,function(c,d){b[d.cache]&&a.push(c)}),a.pop()},transition:function(a,b){var d=l(a),f=d._space(),e=m[f],g=0===this.alpha()?l("transparent"):this,h=g[e.cache]||e.to(g._rgba),k=h.slice();return d=d[e.cache],t(e.props,function(a,f){var e=f.idx,g=h[e],l=d[e],m=p[f.type]||{};null!==l&&(null===g?k[e]=l:(m.mod&&(l-g>m.mod/2?g+=m.mod:g-l>m.mod/2&&(g-=m.mod)),k[e]=c((l-g)*b+g,f)))}),this[f](k)},blend:function(b){if(1===this._rgba[3])return this;var c=this._rgba.slice(),
d=c.pop(),f=l(b)._rgba;return l(a.map(c,function(a,b){return(1-d)*f[b]+d*a}))},toRgbaString:function(){var b="rgba(",c=a.map(this._rgba,function(a,b){return null==a?2<b?1:0:a});return 1===c[3]&&(c.pop(),b="rgb("),b+c.join()+")"},toHslaString:function(){var b="hsla(",c=a.map(this.hsla(),function(a,b){return null==a&&(a=2<b?1:0),b&&3>b&&(a=Math.round(100*a)+"%"),a});return 1===c[3]&&(c.pop(),b="hsl("),b+c.join()+")"},toHexString:function(b){var c=this._rgba.slice(),d=c.pop();return b&&c.push(~~(255*
d)),"#"+a.map(c,function(a){return a=(a||0).toString(16),1===a.length?"0"+a:a}).join("")},toString:function(){return 0===this._rgba[3]?"transparent":this.toRgbaString()}});l.fn.parse.prototype=l.fn;m.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b,c,d=a[0]/255,f=a[1]/255,e=a[2]/255;a=a[3];var g=Math.max(d,f,e),h=Math.min(d,f,e),l=g-h,k=g+h,m=0.5*k;return b=h===g?0:d===g?60*(f-e)/l+360:f===g?60*(e-d)/l+120:60*(d-f)/l+240,c=0===l?0:0.5>=m?l/k:l/(2-k),[Math.round(b)%
360,c,m,null==a?1:a]};m.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,c=a[1],d=a[2];a=a[3];c=0.5>=d?d*(1+c):d+c-d*c;d=2*d-c;return[Math.round(255*e(d,c,b+1/3)),Math.round(255*e(d,c,b)),Math.round(255*e(d,c,b-1/3)),a]};t(m,function(d,f){var e=f.props,g=f.cache,k=f.to,m=f.from;l.fn[d]=function(d){if(k&&!this[g]&&(this[g]=k(this._rgba)),d===b)return this[g].slice();var f,h=a.type(d),p="array"===h||"object"===h?d:arguments,n=this[g].slice();return t(e,
function(a,b){var d=p["object"===h?a:b.idx];null==d&&(d=n[b.idx]);n[b.idx]=c(d,b)}),m?(f=l(m(n)),f[g]=n,f):l(n)};t(e,function(b,c){l.fn[b]||(l.fn[b]=function(f){var e,g=a.type(f),l="alpha"===b?this._hsla?"hsla":"rgba":d,k=this[l](),m=k[c.idx];return"undefined"===g?m:("function"===g&&(f=f.call(this,m),g=a.type(f)),null==f&&c.empty?this:("string"===g&&(e=h.exec(f),e&&(f=m+parseFloat(e[2])*("+"===e[1]?1:-1))),k[c.idx]=f,this[l](k)))})})});l.hook=function(b){b=b.split(" ");t(b,function(b,c){a.cssHooks[c]=
{set:function(b,e){var g,h="";if("transparent"!==e&&("string"!==a.type(e)||(g=d(e)))){if(e=l(g||e),!n.rgba&&1!==e._rgba[3]){for(g="backgroundColor"===c?b.parentNode:b;(""===h||"transparent"===h)&&g&&g.style;)try{h=a.css(g,"backgroundColor"),g=g.parentNode}catch(k){}e=e.blend(h&&"transparent"!==h?h:"_default")}e=e.toRgbaString()}try{b.style[c]=e}catch(m){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=l(b.elem,c),b.end=l(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,b.start.transition(b.end,b.pos))}})};
...
silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(d);(function(){function a(a){var b,c=a.ownerDocument.defaultView?a.ownerDocument.defaultView.getComputedStyle(a,null):a.currentStyle,h={};if(c&&c.length&&c[0]&&c[c[0]])for(a=c.length;a--;)b=c[a],"string"==typeof c[b]&&(h[d.camelCase(b)]=c[b]);else for(b in c)"string"==typeof c[b]&&(h[b]=c[b]);return h}var b=["add","remove","toggle"],c={border:1,borderBottom:1,borderColor:1,borderLeft:1,
borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};d.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(a,b){d.fx.step[b]=function(a){("none"!==a.end&&!a.setAttr||1===a.pos&&!a.setAttr)&&(d.style(a.elem,b,a.end),a.setAttr=!0)}});d.fn.addBack||(d.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});d.effects.animateClass=function(f,e,g,h){var k=d.speed(e,g,h);return this.queue(function(){var e,g=d(this),h=g.attr("class")||
"",n=k.children?g.find("*").addBack():g,n=n.map(function(){return{el:d(this),start:a(this)}});e=function(){d.each(b,function(a,b){f[b]&&g[b+"Class"](f[b])})};e();n=n.map(function(){this.end=a(this.el[0]);var b=this.start,f=this.end,e,g,h={};for(e in f)g=f[e],b[e]!==g&&(c[e]||(d.fx.step[e]||!isNaN(parseFloat(g)))&&(h[e]=g));return this.diff=h,this});g.attr("class",h);n=n.map(function(){var a=this,b=d.Deferred(),c=d.extend({},k,{queue:!1,complete:function(){b.resolve(a)}});return this.el.animate(this.diff,
c),b.promise()});d.when.apply(d,n.get()).done(function(){e();d.each(arguments,function(){var a=this.el;d.each(this.diff,function(b){a.css(b,"")})});k.complete.call(g[0])})})};d.fn.extend({addClass:function(a){return function(b,c,h,k){return c?d.effects.animateClass.call(this,{add:b},c,h,k):a.apply(this,arguments)}}(d.fn.addClass),removeClass:function(a){return function(b,c,h,k){return 1<arguments.length?d.effects.animateClass.call(this,{remove:b},c,h,k):a.apply(this,arguments)}}(d.fn.removeClass),
toggleClass:function(a){return function(b,c,h,k,l){return"boolean"==typeof c||void 0===c?h?d.effects.animateClass.call(this,c?{add:b}:{remove:b},h,k,l):a.apply(this,arguments):d.effects.animateClass.call(this,{toggle:b},c,h,k)}}(d.fn.toggleClass),switchClass:function(a,b,c,h,k){return d.effects.animateClass.call(this,{add:b,remove:a},c,h,k)}})})();(function(){function a(a,b,e,g){return d.isPlainObject(a)&&(b=a,a=a.effect),a={effect:a},null==b&&(b={}),d.isFunction(b)&&(g=b,e=null,b={}),("number"==
typeof b||d.fx.speeds[b])&&(g=e,e=b,b={}),d.isFunction(e)&&(g=e,e=null),b&&d.extend(a,b),e=e||b.duration,a.duration=d.fx.off?0:"number"==typeof e?e:e in d.fx.speeds?d.fx.speeds[e]:d.fx.speeds._default,a.complete=g||b.complete,a}function b(a){return!a||"number"==typeof a||d.fx.speeds[a]?!0:"string"!=typeof a||d.effects.effect[a]?d.isFunction(a)?!0:"object"!=typeof a||a.effect?!1:!0:!0}d.extend(d.effects,{version:"1.11.4",save:function(a,b){for(var d=0;b.length>d;d++)null!==b[d]&&a.data("ui-effects-"+
b[d],a[0].style[b[d]])},restore:function(a,b){var d,g;for(g=0;b.length>g;g++)null!==b[g]&&(d=a.data("ui-effects-"+b[g]),void 0===d&&(d=""),a.css(b[g],d))},setMode:function(a,b){return"toggle"===b&&(b=a.is(":hidden")?"show":"hide"),b},getBaseline:function(a,b){var d,g;switch(a[0]){case "top":d=0;break;case "middle":d=0.5;break;case "bottom":d=1;break;default:d=a[0]/b.height}switch(a[1]){case "left":g=0;break;case "center":g=0.5;break;case "right":g=1;break;default:g=a[1]/b.width}return{x:g,y:d}},createWrapper:function(a){if(a.parent().is(".ui-effects-wrapper"))return a.parent();
var b={width:a.outerWidth(!0),height:a.outerHeight(!0),"float":a.css("float")},e=d("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),g={width:a.width(),height:a.height()},h=document.activeElement;try{h.id}catch(k){h=document.body}return a.wrap(e),(a[0]===h||d.contains(a[0],h))&&d(h).focus(),e=a.parent(),"static"===a.css("position")?(e.css({position:"relative"}),a.css({position:"relative"})):(d.extend(b,{position:a.css("position"),
zIndex:a.css("z-index")}),d.each(["top","left","bottom","right"],function(d,e){b[e]=a.css(e);isNaN(parseInt(b[e],10))&&(b[e]="auto")}),a.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"})),a.css(g),e.css(b).show()},removeWrapper:function(a){var b=document.activeElement;return a.parent().is(".ui-effects-wrapper")&&(a.parent().replaceWith(a),(a[0]===b||d.contains(a[0],b))&&d(b).focus()),a},setTransition:function(a,b,e,g){return g=g||{},d.each(b,function(b,d){var f=a.cssUnit(d);0<f[0]&&
(g[d]=f[0]*e+f[1])}),g}});d.fn.extend({effect:function(){function b(a){function c(){d.isFunction(g)&&g.call(e[0]);d.isFunction(a)&&a()}var e=d(this),g=f.complete,n=f.mode;(e.is(":hidden")?"hide"===n:"show"===n)?(e[n](),c()):h.call(e[0],f,c)}var f=a.apply(this,arguments),e=f.mode,g=f.queue,h=d.effects.effect[f.effect];return d.fx.off||!h?e?this[e](f.duration,f.complete):this.each(function(){f.complete&&f.complete.call(this)}):!1===g?this.each(b):this.queue(g||"fx",b)},show:function(c){return function(d){if(b(d))return c.apply(this,
arguments);var e=a.apply(this,arguments);return e.mode="show",this.effect.call(this,e)}}(d.fn.show),hide:function(c){return function(d){if(b(d))return c.apply(this,arguments);var e=a.apply(this,arguments);return e.mode="hide",this.effect.call(this,e)}}(d.fn.hide),toggle:function(c){return function(d){if(b(d)||"boolean"==typeof d)return c.apply(this,arguments);var e=a.apply(this,arguments);return e.mode="toggle",this.effect.call(this,e)}}(d.fn.toggle),cssUnit:function(a){var b=this.css(a),e=[];return d.each(["em",
"px","%","pt"],function(a,c){0<b.indexOf(c)&&(e=[parseFloat(b),c])}),e}})})();(function(){var a={};d.each(["Quad","Cubic","Quart","Quint","Expo"],function(b,c){a[c]=function(a){return Math.pow(a,b+2)}});d.extend(a,{Sine:function(a){return 1-Math.cos(a*Math.PI/2)},Circ:function(a){return 1-Math.sqrt(1-a*a)},Elastic:function(a){return 0===a||1===a?a:-Math.pow(2,8*(a-1))*Math.sin((80*(a-1)-7.5)*Math.PI/15)},Back:function(a){return a*a*(3*a-2)},Bounce:function(a){for(var c,d=4;((c=Math.pow(2,--d))-1)/
11>a;);return 1/Math.pow(4,3-d)-7.5625*Math.pow((3*c-2)/22-a,2)}});d.each(a,function(a,c){d.easing["easeIn"+a]=c;d.easing["easeOut"+a]=function(a){return 1-c(1-a)};d.easing["easeInOut"+a]=function(a){return 0.5>a?c(2*a)/2:1-c(-2*a+2)/2}})})();d.effects;d.effects.effect.blind=function(a,b){var c,f,e,g=d(this),h="position top bottom left right height width".split(" "),k=d.effects.setMode(g,a.mode||"hide");c=a.direction||"up";var l=/up|down|vertical/.test(c),m=l?"height":"width",p=l?"top":"left",n=/up|left|vertical|horizontal/.test(c),
q={},t="show"===k;g.parent().is(".ui-effects-wrapper")?d.effects.save(g.parent(),h):d.effects.save(g,h);g.show();c=d.effects.createWrapper(g).css({overflow:"hidden"});f=c[m]();e=parseFloat(c.css(p))||0;q[m]=t?f:0;n||(g.css(l?"bottom":"right",0).css(l?"top":"left","auto").css({position:"absolute"}),q[p]=t?e:f+e);t&&(c.css(m,0),n||c.css(p,e+f));c.animate(q,{duration:a.duration,easing:a.easing,queue:!1,complete:function(){"hide"===k&&g.hide();d.effects.restore(g,h);d.effects.removeWrapper(g);b()}})};
d.effects.effect.bounce=function(a,b){var c,f,e,g=d(this),h="position top bottom left right height width".split(" "),k=d.effects.setMode(g,a.mode||"effect"),l="hide"===k;c="show"===k;var m=a.direction||"up",k=a.distance,p=a.times||5,n=2*p+(c||l?1:0),q=a.duration/n,t=a.easing,r="up"===m||"down"===m?"top":"left",m="up"===m||"left"===m,s=g.queue(),u=s.length;(c||l)&&h.push("opacity");d.effects.save(g,h);g.show();d.effects.createWrapper(g);k||(k=g["top"===r?"outerHeight":"outerWidth"]()/3);c&&(e={opacity:1},
e[r]=0,g.css("opacity",0).css(r,m?2*-k:2*k).animate(e,q,t));l&&(k/=Math.pow(2,p-1));e={};for(c=e[r]=0;p>c;c++)f={},f[r]=(m?"-=":"+=")+k,g.animate(f,q,t).animate(e,q,t),k=l?2*k:k/2;l&&(f={opacity:0},f[r]=(m?"-=":"+=")+k,g.animate(f,q,t));g.queue(function(){l&&g.hide();d.effects.restore(g,h);d.effects.removeWrapper(g);b()});1<u&&s.splice.apply(s,[1,0].concat(s.splice(u,n+1)));g.dequeue()};d.effects.effect.clip=function(a,b){var c,f,e=d(this),g="position top bottom left right height width".split(" "),
h="show"===d.effects.setMode(e,a.mode||"hide"),k="vertical"===(a.direction||"vertical"),l=k?"height":"width",k=k?"top":"left",m={};d.effects.save(e,g);e.show();c=d.effects.createWrapper(e).css({overflow:"hidden"});c="IMG"===e[0].tagName?c:e;f=c[l]();h&&(c.css(l,0),c.css(k,f/2));m[l]=h?f:0;m[k]=h?0:f/2;c.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){h||e.hide();d.effects.restore(e,g);d.effects.removeWrapper(e);b()}})};d.effects.effect.drop=function(a,b){var c,f=d(this),
e="position top bottom left right opacity height width".split(" "),g=d.effects.setMode(f,a.mode||"hide"),h="show"===g;c=a.direction||"left";var k="up"===c||"down"===c?"top":"left",l="up"===c||"left"===c?"pos":"neg",m={opacity:h?1:0};d.effects.save(f,e);f.show();d.effects.createWrapper(f);c=a.distance||f["top"===k?"outerHeight":"outerWidth"](!0)/2;h&&f.css("opacity",0).css(k,"pos"===l?-c:c);m[k]=(h?"pos"===l?"+=":"-=":"pos"===l?"-=":"+=")+c;f.animate(m,{queue:!1,duration:a.duration,easing:a.easing,
complete:function(){"hide"===g&&f.hide();d.effects.restore(f,e);d.effects.removeWrapper(f);b()}})};d.effects.effect.explode=function(a,b){function c(){u.push(this);u.length===m*p&&(n.css({visibility:"visible"}),d(u).remove(),q||n.hide(),b())}var f,e,g,h,k,l,m=a.pieces?Math.round(Math.sqrt(a.pieces)):3,p=m,n=d(this),q="show"===d.effects.setMode(n,a.mode||"hide"),t=n.show().css("visibility","hidden").offset(),r=Math.ceil(n.outerWidth()/p),s=Math.ceil(n.outerHeight()/m),u=[];for(f=0;m>f;f++)for(h=t.top+
f*s,l=f-(m-1)/2,e=0;p>e;e++)g=t.left+e*r,k=e-(p-1)/2,n.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-e*r,top:-f*s}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:r,height:s,left:g+(q?k*r:0),top:h+(q?l*s:0),opacity:q?0:1}).animate({left:g+(q?0:k*r),top:h+(q?0:l*s),opacity:q?1:0},a.duration||500,a.easing,c)};d.effects.effect.fade=function(a,b){var c=d(this),f=d.effects.setMode(c,a.mode||"toggle");c.animate({opacity:f},
{queue:!1,duration:a.duration,easing:a.easing,complete:b})};d.effects.effect.fold=function(a,b){var c,f,e=d(this),g="position top bottom left right height width".split(" ");c=d.effects.setMode(e,a.mode||"hide");var h="show"===c,k="hide"===c,l=a.size||15,m=/([0-9]+)%/.exec(l),p=!!a.horizFirst,n=(f=h!==p)?["width","height"]:["height","width"],q=a.duration/2,t={},r={};d.effects.save(e,g);e.show();c=d.effects.createWrapper(e).css({overflow:"hidden"});f=f?[c.width(),c.height()]:[c.height(),c.width()];
m&&(l=parseInt(m[1],10)/100*f[k?0:1]);h&&c.css(p?{height:0,width:l}:{height:l,width:0});t[n[0]]=h?f[0]:l;r[n[1]]=h?f[1]:0;c.animate(t,q,a.easing).animate(r,q,a.easing,function(){k&&e.hide();d.effects.restore(e,g);d.effects.removeWrapper(e);b()})};d.effects.effect.highlight=function(a,b){var c=d(this),f=["backgroundImage","backgroundColor","opacity"],e=d.effects.setMode(c,a.mode||"show"),g={backgroundColor:c.css("backgroundColor")};"hide"===e&&(g.opacity=0);d.effects.save(c,f);c.show().css({backgroundImage:"none",
...
"borderRightWidth","paddingLeft","paddingRight"],r=d.effects.setMode(l,a.mode||"effect"),s=a.restore||"effect"!==r,u=a.scale||"both",z=a.origin||["middle","center"],B=l.css("position"),A=s?m:h,v={height:0,width:0,outerHeight:0,outerWidth:0};"show"===r&&l.show();h={height:l.height(),width:l.width(),outerHeight:l.outerHeight(),outerWidth:l.outerWidth()};"toggle"===a.mode&&"show"===r?(l.from=a.to||v,l.to=a.from||h):(l.from=a.from||("show"===r?v:h),l.to=a.to||("hide"===r?v:h));e=l.from.height/h.height;
g=l.from.width/h.width;c=l.to.height/h.height;f=l.to.width/h.width;("box"===u||"both"===u)&&(e!==c&&(A=A.concat(q),l.from=d.effects.setTransition(l,q,e,l.from),l.to=d.effects.setTransition(l,q,c,l.to)),g!==f&&(A=A.concat(t),l.from=d.effects.setTransition(l,t,g,l.from),l.to=d.effects.setTransition(l,t,f,l.to)));("content"===u||"both"===u)&&e!==c&&(A=A.concat(n).concat(p),l.from=d.effects.setTransition(l,n,e,l.from),l.to=d.effects.setTransition(l,n,c,l.to));d.effects.save(l,A);l.show();d.effects.createWrapper(l);
l.css("overflow","hidden").css(l.from);z&&(k=d.effects.getBaseline(z,h),l.from.top=(h.outerHeight-l.outerHeight())*k.y,l.from.left=(h.outerWidth-l.outerWidth())*k.x,l.to.top=(h.outerHeight-l.to.outerHeight)*k.y,l.to.left=(h.outerWidth-l.to.outerWidth)*k.x);l.css(l.from);"content"!==u&&"both"!==u||(q=q.concat(["marginTop","marginBottom"]).concat(n),t=t.concat(["marginLeft","marginRight"]),p=m.concat(q).concat(t),l.find("*[width]").each(function(){var b=d(this),h=b.height(),l=b.width(),k=b.outerHeight(),
m=b.outerWidth();s&&d.effects.save(b,p);b.from={height:h*e,width:l*g,outerHeight:k*e,outerWidth:m*g};b.to={height:h*c,width:l*f,outerHeight:h*c,outerWidth:l*f};e!==c&&(b.from=d.effects.setTransition(b,q,e,b.from),b.to=d.effects.setTransition(b,q,c,b.to));g!==f&&(b.from=d.effects.setTransition(b,t,g,b.from),b.to=d.effects.setTransition(b,t,f,b.to));b.css(b.from);b.animate(b.to,a.duration,a.easing,function(){s&&d.effects.restore(b,p)})}));l.animate(l.to,{queue:!1,duration:a.duration,easing:a.easing,
complete:function(){0===l.to.opacity&&l.css("opacity",l.from.opacity);"hide"===r&&l.hide();d.effects.restore(l,A);s||("static"===B?l.css({position:"relative",top:l.to.top,left:l.to.left}):d.each(["top","left"],function(a,b){l.css(b,function(b,c){var d=parseInt(c,10),f=a?l.to.left:l.to.top;return"auto"===c?f+"px":d+f+"px"})}));d.effects.removeWrapper(l);b()}})};d.effects.effect.scale=function(a,b){var c=d(this),f=d.extend(!0,{},a),e=d.effects.setMode(c,a.mode||"effect"),g=parseInt(a.percent,10)||(0===
parseInt(a.percent,10)?0:"hide"===e?0:100),h=a.direction||"both",k=a.origin,l={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()},m="horizontal"!==h?g/100:1,g="vertical"!==h?g/100:1;f.effect="size";f.queue=!1;f.complete=b;"effect"!==e&&(f.origin=k||["middle","center"],f.restore=!0);f.from=a.from||("show"===e?{height:0,width:0,outerHeight:0,outerWidth:0}:l);f.to={height:l.height*m,width:l.width*g,outerHeight:l.outerHeight*m,outerWidth:l.outerWidth*g};f.fade&&("show"===
e&&(f.from.opacity=0,f.to.opacity=1),"hide"===e&&(f.from.opacity=1,f.to.opacity=0));c.effect(f)};d.effects.effect.puff=function(a,b){var c=d(this),f=d.effects.setMode(c,a.mode||"hide"),e="hide"===f,g=parseInt(a.percent,10)||150,h=g/100,k={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()};d.extend(a,{effect:"scale",queue:!1,fade:!0,mode:f,complete:b,percent:e?g:100,from:e?k:{height:k.height*h,width:k.width*h,outerHeight:k.outerHeight*h,outerWidth:k.outerWidth*
h}});c.effect(a)};d.effects.effect.pulsate=function(a,b){var c,f=d(this),e=d.effects.setMode(f,a.mode||"show");c="show"===e;var g="hide"===e,e=2*(a.times||5)+(c||"hide"===e?1:0),h=a.duration/e,k=0,l=f.queue(),m=l.length;(c||!f.is(":visible"))&&(f.css("opacity",0).show(),k=1);for(c=1;e>c;c++)f.animate({opacity:k},h,a.easing),k=1-k;f.animate({opacity:k},h,a.easing);f.queue(function(){g&&f.hide();b()});1<m&&l.splice.apply(l,[1,0].concat(l.splice(m,e+1)));f.dequeue()};d.effects.effect.shake=function(a,
b){var c,f=d(this),e="position top bottom left right height width".split(" "),g=d.effects.setMode(f,a.mode||"effect"),h=a.direction||"left";c=a.distance||20;var k=a.times||3,l=2*k+1,m=Math.round(a.duration/l),p="up"===h||"down"===h?"top":"left",n="up"===h||"left"===h,h={},q={},t={},r=f.queue(),s=r.length;d.effects.save(f,e);f.show();d.effects.createWrapper(f);h[p]=(n?"-=":"+=")+c;q[p]=(n?"+=":"-=")+2*c;t[p]=(n?"-=":"+=")+2*c;f.animate(h,m,a.easing);for(c=1;k>c;c++)f.animate(q,m,a.easing).animate(t,
m,a.easing);f.animate(q,m,a.easing).animate(h,m/2,a.easing).queue(function(){"hide"===g&&f.hide();d.effects.restore(f,e);d.effects.removeWrapper(f);b()});1<s&&r.splice.apply(r,[1,0].concat(r.splice(s,l+1)));f.dequeue()};d.effects.effect.slide=function(a,b){var c,f=d(this),e="position top bottom left right width height".split(" "),g=d.effects.setMode(f,a.mode||"show"),h="show"===g;c=a.direction||"left";var k="up"===c||"down"===c?"top":"left",l="up"===c||"left"===c,m={};d.effects.save(f,e);f.show();
c=a.distance||f["top"===k?"outerHeight":"outerWidth"](!0);d.effects.createWrapper(f).css({overflow:"hidden"});h&&f.css(k,l?isNaN(c)?"-"+c:-c:c);m[k]=(h?l?"+=":"-=":l?"-=":"+=")+c;f.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===g&&f.hide();d.effects.restore(f,e);d.effects.removeWrapper(f);b()}})};d.effects.effect.transfer=function(a,b){var c=d(this),f=d(a.to),e="fixed"===f.css("position"),g=d("body"),h=e?g.scrollTop():0,g=e?g.scrollLeft():0,k=f.offset(),f={top:k.top-
h,left:k.left-g,height:f.innerHeight(),width:f.innerWidth()},k=c.offset(),l=d("<div class='ui-effects-transfer'></div>").appendTo(document.body).addClass(a.className).css({top:k.top-h,left:k.left-g,height:c.innerHeight(),width:c.innerWidth(),position:e?"fixed":"absolute"}).animate(f,a.duration,a.easing,function(){l.remove();b()})};d.widget("ui.progressbar",{version:"1.11.4",options:{max:100,value:0,change:null,complete:null},min:0,_create:function(){this.oldValue=this.options.value=this._constrainedValue();
...
this.indeterminate?(this.element.removeAttr("aria-valuenow"),this.overlayDiv||(this.overlayDiv=d("<div class='ui-progressbar-overlay'></div>").appendTo(this.valueDiv))):(this.element.attr({"aria-valuemax":this.options.max,"aria-valuenow":a}),this.overlayDiv&&(this.overlayDiv.remove(),this.overlayDiv=null));this.oldValue!==a&&(this.oldValue=a,this._trigger("change"));a===this.options.max&&this._trigger("complete")}});d.widget("ui.selectable",d.ui.mouse,{version:"1.11.4",options:{appendTo:"body",autoRefresh:!0,
distance:0,filter:"*",tolerance:"touch",selected:null,selecting:null,start:null,stop:null,unselected:null,unselecting:null},_create:function(){var a,b=this;this.element.addClass("ui-selectable");this.dragged=!1;this.refresh=function(){a=d(b.options.filter,b.element[0]);a.addClass("ui-selectee");a.each(function(){var a=d(this),b=a.offset();d.data(this,"selectable-item",{element:this,$element:a,left:b.left,top:b.top,right:b.left+a.outerWidth(),bottom:b.top+a.outerHeight(),startselected:!1,selected:a.hasClass("ui-selected"),
...
e=d.data(this,"selectable-item");return e?(c=!a.metaKey&&!a.ctrlKey||!e.$element.hasClass("ui-selected"),e.$element.removeClass(c?"ui-unselecting":"ui-selected").addClass(c?"ui-selecting":"ui-unselecting"),e.unselecting=!c,e.selecting=c,e.selected=c,c?b._trigger("selecting",a,{selecting:e.element}):b._trigger("unselecting",a,{unselecting:e.element}),!1):void 0}))},_mouseDrag:function(a){if(this.dragged=!0,!this.options.disabled){var b,c=this,f=this.options,e=this.opos[0],g=this.opos[1],h=a.pageX,
k=a.pageY;return e>h&&(b=h,h=e,e=b),g>k&&(b=k,k=g,g=b),this.helper.css({left:e,top:g,width:h-e,height:k-g}),this.selectees.each(function(){var b=d.data(this,"selectable-item"),m=!1;b&&b.element!==c.element[0]&&("touch"===f.tolerance?m=!(b.left>h||e>b.right||b.top>k||g>b.bottom):"fit"===f.tolerance&&(m=b.left>e&&h>b.right&&b.top>g&&k>b.bottom),m?(b.selected&&(b.$element.removeClass("ui-selected"),b.selected=!1),b.unselecting&&(b.$element.removeClass("ui-unselecting"),b.unselecting=!1),b.selecting||
(b.$element.addClass("ui-selecting"),b.selecting=!0,c._trigger("selecting",a,{selecting:b.element}))):(b.selecting&&((a.metaKey||a.ctrlKey)&&b.startselected?(b.$element.removeClass("ui-selecting"),b.selecting=!1,b.$element.addClass("ui-selected"),b.selected=!0):(b.$element.removeClass("ui-selecting"),b.selecting=!1,b.startselected&&(b.$element.addClass("ui-unselecting"),b.unselecting=!0),c._trigger("unselecting",a,{unselecting:b.element}))),b.selected&&(a.metaKey||a.ctrlKey||b.startselected||(b.$element.removeClass("ui-selected"),
...
"-button",menu:a+"-menu"};this._drawButton();this._drawMenu();this.options.disabled&&this.disable()},_drawButton:function(){var a=this;this.label=d("label[for='"+this.ids.element+"']").attr("for",this.ids.button);this._on(this.label,{click:function(a){this.button.focus();a.preventDefault()}});this.element.hide();this.button=d("<span>",{"class":"ui-selectmenu-button ui-widget ui-state-default ui-corner-all",tabindex:this.options.disabled?-1:0,id:this.ids.button,role:"combobox","aria-expanded":"false",
"aria-autocomplete":"list","aria-owns":this.ids.menu,"aria-haspopup":"true"}).insertAfter(this.element);d("<span>",{"class":"ui-icon "+this.options.icons.button}).prependTo(this.button);this.buttonText=d("<span>",{"class":"ui-selectmenu-text"}).appendTo(this.button);this._setText(this.buttonText,this.element.find("option:selected").text());this._resizeButton();this._on(this.button,this._buttonEvents);this.button.one("focusin",function(){a.menuItems||a._refreshMenu()});this._hoverable(this.button);
this._focusable(this.button)},_drawMenu:function(){var a=this;this.menu=d("<ul>",{"aria-hidden":"true","aria-labelledby":this.ids.button,id:this.ids.menu});this.menuWrap=d("<div>",{"class":"ui-selectmenu-menu ui-front"}).append(this.menu).appendTo(this._appendTo());this.menuInstance=this.menu.menu({role:"listbox",select:function(b,c){b.preventDefault();a._setSelection();a._select(c.item.data("ui-selectmenu-item"),b)},focus:function(b,c){var d=c.item.data("ui-selectmenu-item");null!=a.focusIndex&&
...
(this.options.value=this._trimAlignValue(a),this._refreshValue(),this._change(null,0),void 0):this._value()},values:function(a,b){var c,f,e;if(1<arguments.length)return this.options.values[a]=this._trimAlignValue(b),this._refreshValue(),this._change(null,a),void 0;if(!arguments.length)return this._values();if(!d.isArray(arguments[0]))return this.options.values&&this.options.values.length?this._values(a):this.value();c=this.options.values;f=arguments[0];for(e=0;c.length>e;e+=1)c[e]=this._trimAlignValue(f[e]),
...
b?0:a.length-b-1},_valueMin:function(){return this.options.min},_valueMax:function(){return this.max},_refreshValue:function(){var a,b,c,f,e,g=this.options.range,h=this.options,k=this,l=this._animateOff?!1:h.animate,m={};this.options.values&&this.options.values.length?this.handles.each(function(c){b=100*((k.values(c)-k._valueMin())/(k._valueMax()-k._valueMin()));m["horizontal"===k.orientation?"left":"bottom"]=b+"%";d(this).stop(1,1)[l?"animate":"css"](m,h.animate);!0===k.options.range&&("horizontal"===
k.orientation?(0===c&&k.range.stop(1,1)[l?"animate":"css"]({left:b+"%"},h.animate),1===c&&k.range[l?"animate":"css"]({width:b-a+"%"},{queue:!1,duration:h.animate})):(0===c&&k.range.stop(1,1)[l?"animate":"css"]({bottom:b+"%"},h.animate),1===c&&k.range[l?"animate":"css"]({height:b-a+"%"},{queue:!1,duration:h.animate})));a=b}):(c=this.value(),f=this._valueMin(),e=this._valueMax(),b=e!==f?(c-f)/(e-f)*100:0,m["horizontal"===this.orientation?"left":"bottom"]=b+"%",this.handle.stop(1,1)[l?"animate":"css"](m,
...
this._mouseDestroy();for(var a=this.items.length-1;0<=a;a--)this.items[a].item.removeData(this.widgetName+"-item");return this},_mouseCapture:function(a,b){var c=null,f=!1,e=this;return this.reverting?!1:this.options.disabled||"static"===this.options.type?!1:(this._refreshItems(a),d(a.target).parents().each(function(){return d.data(this,e.widgetName+"-item")===e?(c=d(this),!1):void 0}),d.data(a.target,e.widgetName+"-item")===e&&(c=d(a.target)),c?!this.options.handle||b||(d(this.options.handle,c).find("*").addBack().each(function(){this===
...
"original"!==this.options.helper&&this.helper&&this.helper[0].parentNode&&this.helper.remove(),d.extend(this,{helper:null,dragging:!1,reverting:!1,_noFinalSort:null}),this.domPosition.prev?d(this.domPosition.prev).after(this.currentItem):d(this.domPosition.parent).prepend(this.currentItem)),this},serialize:function(a){var b=this._getItemsAsjQuery(a&&a.connected),c=[];return a=a||{},d(b).each(function(){var b=(d(a.item||this).attr(a.attribute||"id")||"").match(a.expression||/(.+)[\-=_](.+)/);b&&c.push((a.key||
b[1]+"[]")+"="+(a.key&&a.expression?b[1]:b[2]))}),!c.length&&a.key&&c.push(a.key+"="),c.join("&")},toArray:function(a){var b=this._getItemsAsjQuery(a&&a.connected),c=[];return a=a||{},b.each(function(){c.push(d(a.item||this).attr(a.attribute||"id")||"")}),c},_intersectsWith:function(a){var b=this.positionAbs.left,c=b+this.helperProportions.width,d=this.positionAbs.top,e=d+this.helperProportions.height,g=a.left,h=g+a.width,k=a.top,l=k+a.height,m=this.offset.click.top,p=this.offset.click.left,p="y"===
this.options.axis||b+p>g&&h>b+p,m=("x"===this.options.axis||d+m>k&&l>d+m)&&p;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?m:b+this.helperProportions.width/2>g&&h>c-this.helperProportions.width/2&&d+this.helperProportions.height/2>k&&l>e-this.helperProportions.height/2},_intersectsWithPointer:function(a){var b="x"===this.options.axis||this._isOverAxis(this.positionAbs.top+
...
[];this.containers=[this];var b,c,f,e,g,h=this.items,k=[[d.isFunction(this.options.items)?this.options.items.call(this.element[0],a,{item:this.currentItem}):d(this.options.items,this.element),this]];if((g=this._connectWith())&&this.ready)for(b=g.length-1;0<=b;b--)for(f=d(g[b],this.document[0]),c=f.length-1;0<=c;c--)(e=d.data(f[c],this.widgetFullName))&&e!==this&&!e.options.disabled&&(k.push([d.isFunction(e.options.items)?e.options.items.call(e.element[0],a,{item:this.currentItem}):d(e.options.items,
e.element),e]),this.containers.push(e));for(b=k.length-1;0<=b;b--)for(a=k[b][1],f=k[b][0],c=0,g=f.length;g>c;c++)e=d(f[c]),e.data(this.widgetName+"-item",a),h.push({item:e,instance:a,width:0,height:0,left:0,top:0})},refreshPositions:function(a){this.floating=this.items.length?"x"===this.options.axis||this._isFloating(this.items[0].item):!1;this.offsetParent&&this.helper&&(this.offset.parent=this._getParentOffset());var b,c,f,e;for(b=this.items.length-1;0<=b;b--)c=this.items[b],c.instance!==this.currentContainer&&
this.currentContainer&&c.item[0]!==this.currentItem[0]||(f=this.options.toleranceElement?d(this.options.toleranceElement,c.item):c.item,a||(c.width=f.outerWidth(),c.height=f.outerHeight()),e=f.offset(),c.left=e.left,c.top=e.top);if(this.options.custom&&this.options.custom.refreshContainers)this.options.custom.refreshContainers.call(this);else for(b=this.containers.length-1;0<=b;b--)e=this.containers[b].element.offset(),this.containers[b].containerCache.left=e.left,this.containers[b].containerCache.top=
...
f=null;e=(c=e.floating||this._isFloating(this.currentItem))?"left":"top";g=c?"width":"height";l=c?"clientX":"clientY";for(c=this.items.length-1;0<=c;c--)d.contains(this.containers[m].element[0],this.items[c].item[0])&&this.items[c].item[0]!==this.currentItem[0]&&(h=this.items[c].item.offset()[e],k=!1,a[l]-h>this.items[c][g]/2&&(k=!0),b>Math.abs(a[l]-h)&&(b=Math.abs(a[l]-h),f=this.items[c],this.direction=k?"up":"down"));if(f||this.options.dropOnEmpty){if(this.currentContainer===this.containers[m])return this.currentContainer.containerCache.over||
...
this.margins.top);"bottom"in a&&(this.offset.click.top=this.helperProportions.height-a.bottom+this.margins.top)},_getParentOffset:function(){this.offsetParent=this.helper.offsetParent();var a=this.offsetParent.offset();return"absolute"===this.cssPosition&&this.scrollParent[0]!==this.document[0]&&d.contains(this.scrollParent[0],this.offsetParent[0])&&(a.left+=this.scrollParent.scrollLeft(),a.top+=this.scrollParent.scrollTop()),(this.offsetParent[0]===this.document[0].body||this.offsetParent[0].tagName&&
...
10)||0)-(parseInt(d(a).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top])},_convertPositionTo:function(a,b){b||(b=this.position);var c="absolute"===a?1:-1,f="absolute"!==this.cssPosition||this.scrollParent[0]!==this.document[0]&&d.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,e=/(html|body)/i.test(f[0].tagName);return{top:b.top+this.offset.relative.top*c+this.offset.parent.top*c-("fixed"===this.cssPosition?-this.scrollParent.scrollTop():
e?0:f.scrollTop())*c,left:b.left+this.offset.relative.left*c+this.offset.parent.left*c-("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():e?0:f.scrollLeft())*c}},_generatePosition:function(a){var b,c,f=this.options,e=a.pageX,g=a.pageY,h="absolute"!==this.cssPosition||this.scrollParent[0]!==this.document[0]&&d.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,k=/(html|body)/i.test(h[0].tagName);return"relative"!==this.cssPosition||this.scrollParent[0]!==
...
"focus"+this.eventNamespace,function(){d(this).closest("li").is(".ui-state-disabled")&&this.blur()});this.tabs=this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({role:"tab",tabIndex:-1});this.anchors=this.tabs.map(function(){return d("a",this)[0]}).addClass("ui-tabs-anchor").attr({role:"presentation",tabIndex:-1});this.panels=d();this.anchors.each(function(b,c){var f,k,l,m=d(c).uniqueId().attr("id"),p=d(c).closest("li"),n=p.attr("aria-controls");a._isLocal(c)?
...
this.options.hide,function(){c._removeTooltip(d(this))}),f.removeData("ui-tooltip-open"),this._off(f,"mouseleave focusout keyup"),f[0]!==this.element[0]&&this._off(f,"remove"),this._off(this.document,"mousemove"),a&&"mouseleave"===a.type&&d.each(this.parents,function(a,b){d(b.element).attr("title",b.title);delete c.parents[a]}),e.closing=!0,this._trigger("close",a,{tooltip:b}),e.hiding||(e.closing=!1)),void 0):(f.removeData("ui-tooltip-open"),void 0)},_tooltip:function(a){var b=d("<div>").attr("role",
...
e=c.element;f.target=f.currentTarget=e[0];a.close(f,!0);d("#"+b).remove();e.data("ui-tooltip-title")&&(e.attr("title")||e.attr("title",e.data("ui-tooltip-title")),e.removeData("ui-tooltip-title"))});this.liveRegion.remove()}})});
