...
(function(a){"function"===typeof define&&define.amd?define(["jquery","datatables.net-bs4","datatables.net-responsive"],function(c){return a(c,window,document)}):"object"===typeof exports?module.exports=function(c,b){c||(c=window);b&&b.fn.dataTable||(b=require("datatables.net-bs4")(c,b).$);b.fn.dataTable.Responsive||require("datatables.net-responsive")(c,b);return a(b,c,c.document)}:a(jQuery,window,document)})(function(a){var c=a.fn.dataTable,b=c.Responsive.display,e=b.modal,d=a('<div class="modal fade dtr-bs-modal" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"/></div></div></div>');
b.modal=function(b){return function(c,g,f){if(a.fn.modal){if(!g){if(b&&b.header){g=d.find("div.modal-header");var h=g.find("button").detach();g.empty().append('<h4 class="modal-title">'+b.header(c)+"</h4>").prepend(h)}d.find("div.modal-body").empty().append(f());d.appendTo("body").modal()}}else e(c,g,f)}};return c.Responsive});
