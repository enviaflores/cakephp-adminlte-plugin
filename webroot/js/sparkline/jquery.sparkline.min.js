...
if(h.fn.sparkline.canvas===k)if(c=v.createElement("canvas"),c.getContext&&c.getContext("2d"))h.fn.sparkline.canvas=function(a,b,c,d){return new R(a,b,c,d)};else{if(!v.namespaces||v.namespaces.v)return h.fn.sparkline.canvas=!1,!1;v.namespaces.add("v","urn:schemas-microsoft-com:vml","#default#VML");h.fn.sparkline.canvas=function(a,b,c,d){return new S(a,b,c)}}return a===k&&(a=h(this).innerWidth()),b===k&&(b=h(this).innerHeight()),e=h.fn.sparkline.canvas(a,b,this,d),f=h(this).data("_jqs_mhandler"),f&&
...
z=[];h.fn.sparkline=function(a,b){return this.each(function(){var c=new h.fn.sparkline.options(this,b),d=h(this),e,f;e=function(){var b,f,e,g,n;if("html"===a||a===k){b=this.getAttribute(c.get("tagValuesAttribute"));if(b===k||null===b)b=d.html();b=b.replace(/(^\s*\x3c!--)|(--\x3e\s*$)|\s+/g,"").split(",")}else b=a;f="auto"===c.get("width")?b.length*c.get("defaultPixelsPerValue"):c.get("width");"auto"===c.get("height")?c.get("composite")&&h.data(this,"_jqs_vcanvas")||(g=v.createElement("span"),g.innerHTML=
"a",d.html(g),e=h(g).innerHeight()||h(g).height(),h(g).remove()):e=c.get("height");c.get("disableInteraction")?n=!1:(n=h.data(this,"_jqs_mhandler"),n?c.get("composite")||n.reset():(n=new Y(this,c),h.data(this,"_jqs_mhandler",n)));c.get("composite")&&!h.data(this,"_jqs_vcanvas")?h.data(this,"_jqs_errnotify")||(alert("Attempted to attach a composite sparkline to an element with no existing sparkline"),h.data(this,"_jqs_errnotify",!0)):(e=new (h.fn.sparkline[c.get("type")])(this,b,c,f,e),e.render(),
n&&n.registerSparkline(e))};if(h(this).html()&&!c.get("disableHiddenCheck")&&h(this).is(":hidden")||!h(this).parents("body").length){if(!c.get("composite")&&h.data(this,"_jqs_pending"))for(f=z.length;f;f--)z[f-1][0]==this&&z.splice(f-1,1);z.push([this,e]);h.data(this,"_jqs_pending",!0)}else e.call(this)})};h.fn.sparkline.defaults={common:{type:"line",lineColor:"#00f",fillColor:"#cdf",defaultPixelsPerValue:3,width:"auto",height:"auto",composite:!1,tagValuesAttribute:"values",tagOptionsPrefix:"spark",
...
tristate:{barWidth:4,barSpacing:1,posBarColor:"#6f6",negBarColor:"#f44",zeroBarColor:"#999",colorMap:{},tooltipFormat:new A('<span style="color: {{color}}">&#9679;</span> {{value:map}}'),tooltipValueLookups:{map:{"-1":"Loss",0:"Draw",1:"Win"}}},discrete:{lineHeight:"auto",thresholdColor:k,thresholdValue:0,chartRangeMax:k,chartRangeMin:k,chartRangeClip:!1,tooltipFormat:new A("{{prefix}}{{value}}{{suffix}}")},bullet:{targetColor:"#f33",targetWidth:3,performanceColor:"#33f",rangeColors:["#d3dafe","#a8b6ff",
"#7f94ff"],base:k,tooltipFormat:new A("{{fieldkey:fields}} - {{value}}"),tooltipValueLookups:{fields:{r:"Range",p:"Performance",t:"Target"}}},pie:{offset:0,sliceColors:"#3366cc #dc3912 #ff9900 #109618 #66aa00 #dd4477 #0099c6 #990099".split(" "),borderWidth:0,borderColor:"#000",tooltipFormat:new A('<span style="color: {{color}}">&#9679;</span> {{value}} ({{percent.1}}%)')},box:{raw:!1,boxLineColor:"#000",boxFillColor:"#cdf",whiskerColor:"#000",outlierLineColor:"#333",outlierFillColor:"#fff",medianColor:"#f00",
showOutliers:!0,outlierIQR:1.5,spotRadius:1.5,target:k,targetColor:"#4a2",chartRangeMax:k,chartRangeMin:k,tooltipFormat:new A("{{field:fields}}: {{value}}"),tooltipFormatFieldlistKey:"field",tooltipValueLookups:{fields:{lq:"Lower Quartile",med:"Median",uq:"Upper Quartile",lo:"Left Outlier",ro:"Right Outlier",lw:"Left Whisker",rw:"Right Whisker"}}}};h.sparkline_display_visible=function(){var a,b,c,d=[];b=0;for(c=z.length;b<c;b++)a=z[b][0],h(a).is(":visible")&&!h(a).parents().is(":hidden")?(z[b][1].call(a),
h.data(z[b][0],"_jqs_pending",!1),d.push(b)):!h(a).closest("html").length&&!h.data(a,"_jqs_pending")&&(h.data(z[b][0],"_jqs_pending",!1),d.push(b));for(b=d.length;b;b--)z.splice(d[b-1],1)};h.fn.sparkline.options=s({init:function(a,b){var c,d,e,f;this.userOptions=b=b||{};this.tag=a;this.tagValCache={};d=h.fn.sparkline.defaults;e=d.common;this.tagOptionsPrefix=b.enableTagOptions&&(b.tagOptionsPrefix||e.tagOptionsPrefix);f=this.getTagSetting("type");f===J?c=d[b.type||e.type]:c=d[f];this.mergedOptions=
h.extend({},e,c,b)},getTagSetting:function(a){var b=this.tagOptionsPrefix,c,d;if(!1===b||b===k)return J;if(this.tagValCache.hasOwnProperty(a))a=this.tagValCache.key;else{a=this.tag.getAttribute(b+a);if(a===k||null===a)a=J;else if("["===a.substr(0,1))for(a=a.substr(1,a.length-2).split(","),b=a.length;b--;)a[b]=G(a[b].replace(/(^\s*)|(\s*$)/g,""));else if("{"===a.substr(0,1))for(c=a.substr(1,a.length-2).split(","),a={},b=c.length;b--;)d=c[b].split(":",2),a[d[0].replace(/(^\s*)|(\s*$)/g,"")]=G(d[1].replace(/(^\s*)|(\s*$)/g,
...
if(!e)return"";h.isArray(e)||(e=[e]);h.isArray(d)||(d=[d]);f=this.options.get("tooltipFormatFieldlist");g=this.options.get("tooltipFormatFieldlistKey");if(f&&g){w=[];for(l=d.length;l--;)m=d[l][g],-1!=(q=h.inArray(m,f))&&(w[q]=d[l]);d=w}f=e.length;n=d.length;for(l=0;l<f;l++)for(m=e[l],"string"==typeof m&&(m=new A(m)),g=m.fclass||"jqsfield",q=0;q<n;q++)d[q].isNull&&a.get("tooltipSkipNull")||(h.extend(d[q],{prefix:a.get("tooltipPrefix"),suffix:a.get("tooltipSuffix")}),w=m.render(d[q],a.get("tooltipValueLookups"),
...
k&&(a.get("chartRangeClipX")||a.get("chartRangeMaxX")>this.maxx)&&(this.maxx=a.get("chartRangeMaxX"))},drawNormalRange:function(a,b,c,d,e){var f=this.options.get("normalRangeMin"),t=this.options.get("normalRangeMax");b+=g.round(c-(t-this.miny)/e*c);c=g.round(c*(t-f)/e);this.target.drawRect(a,b,d,c,k,this.options.get("normalRangeColor")).append()},render:function(){var a=this.options,b=this.target,c=this.canvasWidth,d=this.canvasHeight,e=this.vertices,f=a.get("spotRadius"),t=this.regionMap,w,l,m,n,
q,p,r,u,D,y,F,s,v,B,z,C,x;if(N._super.render.call(this)&&(this.scanValues(),this.processRangeOptions(),z=this.xvalues,C=this.yvalues,this.yminmax.length&&!(2>this.yvalues.length))){n=q=0;w=0===this.maxx-this.minx?1:this.maxx-this.minx;l=0===this.maxy-this.miny?1:this.maxy-this.miny;m=this.yvalues.length-1;f&&(c<4*f||d<4*f)&&(f=0);if(f){if((B=a.get("highlightSpotColor")&&!a.get("disableInteraction"))||a.get("minSpotColor")||a.get("spotColor")&&C[m]===this.miny)d-=g.ceil(f);if(B||a.get("maxSpotColor")||
a.get("spotColor")&&C[m]===this.maxy)d-=g.ceil(f),n+=g.ceil(f);if(B||(a.get("minSpotColor")||a.get("maxSpotColor"))&&(C[0]===this.miny||C[0]===this.maxy))q+=g.ceil(f),c-=g.ceil(f);if(B||a.get("spotColor")||a.get("minSpotColor")||a.get("maxSpotColor")&&(C[m]===this.miny||C[m]===this.maxy))c-=g.ceil(f)}d--;a.get("normalRangeMin")!==k&&!a.get("drawNormalOnTop")&&this.drawNormalRange(q,n,d,c,l);r=[];u=[r];v=null;B=C.length;for(x=0;x<B;x++)D=z[x],F=z[x+1],y=C[x],s=q+g.round(c/w*(D-this.minx)),F=x<B-1?
q+g.round(c/w*(F-this.minx)):c,F=s+(F-s)/2,t[x]=[v||0,F,x],v=F,null===y?x&&(null!==C[x-1]&&(r=[],u.push(r)),e.push(null)):(y<this.miny&&(y=this.miny),y>this.maxy&&(y=this.maxy),r.length||r.push([s,n+d]),p=[s,n+g.round(d-(y-this.miny)/l*d)],r.push(p),e.push(p));e=[];t=[];p=u.length;for(x=0;x<p;x++)r=u[x],r.length&&(a.get("fillColor")&&(r.push([r[r.length-1][0],n+d]),t.push(r.slice(0)),r.pop()),2<r.length&&(r[0]=[r[0][0],r[1][1]]),e.push(r));p=t.length;for(x=0;x<p;x++)b.drawShape(t[x],a.get("fillColor"),
a.get("fillColor")).append();a.get("normalRangeMin")!==k&&a.get("drawNormalOnTop")&&this.drawNormalRange(q,n,d,c,l);p=e.length;for(x=0;x<p;x++)b.drawShape(e[x],a.get("lineColor"),k,a.get("lineWidth")).append();if(f&&a.get("valueSpots"))for(r=a.get("valueSpots"),r.get===k&&(r=new I(r)),x=0;x<B;x++)(u=r.get(C[x]))&&b.drawCircle(q+g.round(c/w*(z[x]-this.minx)),n+g.round(d-(C[x]-this.miny)/l*d),f,k,u).append();f&&a.get("spotColor")&&null!==C[m]&&b.drawCircle(q+g.round(c/w*(z[z.length-1]-this.minx)),n+
g.round(d-(C[m]-this.miny)/l*d),f,k,a.get("spotColor")).append();this.maxy!==this.minyorg&&(f&&a.get("minSpotColor")&&(D=z[h.inArray(this.minyorg,C)],b.drawCircle(q+g.round(c/w*(D-this.minx)),n+g.round(d-(this.minyorg-this.miny)/l*d),f,k,a.get("minSpotColor")).append()),f&&a.get("maxSpotColor")&&(D=z[h.inArray(this.maxyorg,C)],b.drawCircle(q+g.round(c/w*(D-this.minx)),n+g.round(d-(this.maxyorg-this.miny)/l*d),f,k,a.get("maxSpotColor")).append()));this.lastShapeId=b.getLastShapeId();this.canvasTop=
n;b.render()}}});h.fn.sparkline.bar=$=s(h.fn.sparkline._base,E,{type:"bar",init:function(a,b,c,d,e){var f=parseInt(c.get("barWidth"),10),t=parseInt(c.get("barSpacing"),10),w=c.get("chartRangeMin"),l=c.get("chartRangeMax"),m=c.get("chartRangeClip"),n=Infinity,q=-Infinity,p,r,u,D,y,s,v,z,B,A;$._super.init.call(this,a,b,c,d,e);a=0;for(d=b.length;a<d;a++)if(e=b[a],(p="string"==typeof e&&-1<e.indexOf(":"))||h.isArray(e))y=!0,p&&(e=b[a]=L(e.split(":"))),e=T(e,null),p=g.min.apply(g,e),e=g.max.apply(g,e),
p<n&&(n=p),e>q&&(q=e);this.stacked=y;this.regionShapes={};this.barWidth=f;this.barSpacing=t;this.totalBarWidth=f+t;this.width=b.length*f+(b.length-1)*t;this.initTarget();m&&(r=w===k?-Infinity:w,D=l===k?Infinity:l);w=[];f=y?[]:w;l=[];t=[];a=0;for(d=b.length;a<d;a++)if(y)for(p=b[a],b[a]=z=[],l[a]=0,s=f[a]=t[a]=0,v=p.length;s<v;s++)e=z[s]=m?H(p[s],r,D):p[s],null!==e&&(0<e&&(l[a]+=e),0>n&&0<q?0>e?t[a]+=g.abs(e):f[a]+=e:f[a]+=g.abs(e-(0>e?q:n)),w.push(e));else e=m?H(b[a],r,D):b[a],e=b[a]=G(e),null!==e&&
w.push(e);this.max=m=g.max.apply(g,w);this.min=b=g.min.apply(g,w);this.stackMax=q=y?g.max.apply(g,l):m;this.stackMin=y?g.min.apply(g,w):b;c.get("chartRangeMin")!==k&&(c.get("chartRangeClip")||c.get("chartRangeMin")<b)&&(b=c.get("chartRangeMin"));c.get("chartRangeMax")!==k&&(c.get("chartRangeClip")||c.get("chartRangeMax")>m)&&(m=c.get("chartRangeMax"));this.zeroAxis=n=c.get("zeroAxis",!0);0>=b&&0<=m&&n?u=0:0==n?u=b:0<b?u=b:u=m;this.xaxisOffset=u;r=y?g.max.apply(g,f)+g.max.apply(g,t):m-b;this.canvasHeightEf=
...
value:this.values[a],offset:a}},renderRegion:function(a,b){var c=this.options,d=this.min,e=this.range,f=this.interval,h=this.target,k=this.lineHeight,l=this.canvasHeight-k,m,n,q,p;return n=H(this.values[a],d,this.max),p=a*f,m=g.round(l-(n-d)/e*l),q=c.get("thresholdColor")&&n<c.get("thresholdValue")?c.get("thresholdColor"):c.get("lineColor"),b&&(q=this.calcHighlightColor(q,c)),h.drawLine(p,m,p,m+k,q)}});h.fn.sparkline.bullet=O=s(h.fn.sparkline._base,{type:"bullet",init:function(a,b,c,d,e){var f;O._super.init.call(this,
a,b,c,d,e);this.values=b=L(b);a=b.slice();a[0]=null===a[0]?a[2]:a[0];a[1]=null===b[1]?a[2]:a[1];a=g.min.apply(g,b);f=g.max.apply(g,b);c.get("base")===k?a=0>a?a:0:a=c.get("base");this.min=a;this.max=f;this.range=f-a;this.shapes={};this.valueShapes={};this.regiondata={};this.width=d="auto"===c.get("width")?"4.0em":d;this.target=this.$el.simpledraw(d,e,c.get("composite"));b.length||(this.disabled=!0);this.initTarget()},getRegion:function(a,b,c){a=this.target.getShapeAt(a,b,c);return a!==k&&this.shapes[a]!==
k?this.shapes[a]:k},getCurrentRegionFields:function(){var a=this.currentRegion;return{fieldkey:a.substr(0,1),value:this.values[a.substr(1)],region:a}},changeHighlight:function(a){var b=this.currentRegion,c=this.valueShapes[b],d;delete this.shapes[c];switch(b.substr(0,1)){case "r":d=this.renderRange(b.substr(1),a);break;case "p":d=this.renderPerformance(a);break;case "t":d=this.renderTarget(a)}this.valueShapes[b]=d.id;this.shapes[d.id]=b;this.target.replaceWithShape(c,d)},renderRange:function(a,b){var c=
g.round((this.values[a]-this.min)/this.range*this.canvasWidth),d=this.options.get("rangeColors")[a-2];return b&&(d=this.calcHighlightColor(d,this.options)),this.target.drawRect(0,0,c-1,this.canvasHeight-1,d,d)},renderPerformance:function(a){var b=g.round((this.values[1]-this.min)/this.range*this.canvasWidth),c=this.options.get("performanceColor");return a&&(c=this.calcHighlightColor(c,this.options)),this.target.drawRect(0,g.round(0.3*this.canvasHeight),b-1,g.round(0.4*this.canvasHeight)-1,c,c)},renderTarget:function(a){var b=
g.round((this.values[0]-this.min)/this.range*this.canvasWidth-this.options.get("targetWidth")/2),c=g.round(0.1*this.canvasHeight),d=this.canvasHeight-2*c,e=this.options.get("targetColor");return a&&(e=this.calcHighlightColor(e,this.options)),this.target.drawRect(b,c,this.options.get("targetWidth")-1,d-1,e,e)},render:function(){var a=this.values.length,b=this.target,c,d;if(O._super.render.call(this)){for(c=2;c<a;c++)d=this.renderRange(c).append(),this.shapes[d.id]="r"+c,this.valueShapes["r"+c]=d.id;
null!==this.values[1]&&(d=this.renderPerformance().append(),this.shapes[d.id]="p1",this.valueShapes.p1=d.id);null!==this.values[0]&&(d=this.renderTarget().append(),this.shapes[d.id]="t0",this.valueShapes.t0=d.id);b.render()}}});h.fn.sparkline.pie=P=s(h.fn.sparkline._base,{type:"pie",init:function(a,b,c,d,e){var f=0;P._super.init.call(this,a,b,c,d,e);this.shapes={};this.valueShapes={};this.values=b=h.map(b,Number);"auto"===c.get("width")&&(this.width=this.height);if(0<b.length)for(a=b.length;a--;)f+=
b[a];this.total=f;this.initTarget();this.radius=g.floor(g.min(this.canvasWidth,this.canvasHeight)/2)},getRegion:function(a,b,c){a=this.target.getShapeAt(a,b,c);return a!==k&&this.shapes[a]!==k?this.shapes[a]:k},getCurrentRegionFields:function(){var a=this.currentRegion;return{isNull:this.values[a]===k,value:this.values[a],percent:this.values[a]/this.total*100,color:this.options.get("sliceColors")[a%this.options.get("sliceColors").length],offset:a}},changeHighlight:function(a){var b=this.currentRegion;
a=this.renderSlice(b,a);var c=this.valueShapes[b];delete this.shapes[c];this.target.replaceWithShape(c,a);this.valueShapes[b]=a.id;this.shapes[a.id]=b},renderSlice:function(a,b){var c=this.target,d=this.options,e=this.radius,f=d.get("borderWidth"),h=d.get("offset"),w=2*g.PI,l=this.values,m=this.total,h=h?h/360*g.PI*2:0,n,q,p,r,u;r=l.length;for(p=0;p<r;p++){q=n=h;0<m&&(q=h+l[p]/m*w);if(a===p)return u=d.get("sliceColors")[p%d.get("sliceColors").length],b&&(u=this.calcHighlightColor(u,d)),c.drawPieSlice(e,
e,e-f,n,q,k,u);h=q}},render:function(){var a=this.target,b=this.values,c=this.options,d=this.radius,e=c.get("borderWidth"),f;if(P._super.render.call(this)){e&&a.drawCircle(d,d,g.floor(d-e/2),c.get("borderColor"),k,e).append();for(c=b.length;c--;)b[c]&&(f=this.renderSlice(c).append(),this.valueShapes[c]=f.id,this.shapes[f.id]=c);a.render()}}});h.fn.sparkline.box=Q=s(h.fn.sparkline._base,{type:"box",init:function(a,b,c,d,e){Q._super.init.call(this,a,b,c,d,e);this.values=h.map(b,Number);this.width="auto"===
c.get("width")?"4.0em":d;this.initTarget();this.values.length||(this.disabled=1)},getRegion:function(){return 1},getCurrentRegionFields:function(){var a=[{field:"lq",value:this.quartiles[0]},{field:"med",value:this.quartiles[1]},{field:"uq",value:this.quartiles[2]}];return this.loutlier!==k&&a.push({field:"lo",value:this.loutlier}),this.routlier!==k&&a.push({field:"ro",value:this.routlier}),this.lwhisker!==k&&a.push({field:"lw",value:this.lwhisker}),this.rwhisker!==k&&a.push({field:"rw",value:this.rwhisker}),
a},render:function(){var a=this.target,b=this.values,c=b.length,d=this.options,e=this.canvasWidth,f=this.canvasHeight,h=d.get("chartRangeMin")===k?g.min.apply(g,b):d.get("chartRangeMin"),w=d.get("chartRangeMax")===k?g.max.apply(g,b):d.get("chartRangeMax"),l=0,m,n,q,p,r,u,s,y,v;if(Q._super.render.call(this)){if(d.get("raw"))d.get("showOutliers")&&5<b.length?(n=b[0],m=b[1],p=b[2],r=b[3],u=b[4],s=b[5],y=b[6]):(m=b[0],p=b[1],r=b[2],u=b[3],s=b[4]);else if(b.sort(function(a,b){return a-b}),p=K(b,1),r=K(b,
2),u=K(b,3),q=u-p,d.get("showOutliers")){m=s=k;for(n=0;n<c;n++)m===k&&b[n]>p-q*d.get("outlierIQR")&&(m=b[n]),b[n]<u+q*d.get("outlierIQR")&&(s=b[n]);n=b[0];y=b[c-1]}else m=b[0],s=b[c-1];this.quartiles=[p,r,u];this.lwhisker=m;this.rwhisker=s;this.loutlier=n;this.routlier=y;b=e/(w-h+1);d.get("showOutliers")&&(l=g.ceil(d.get("spotRadius")),e-=2*g.ceil(d.get("spotRadius")),b=e/(w-h+1),n<m&&a.drawCircle((n-h)*b+l,f/2,d.get("spotRadius"),d.get("outlierLineColor"),d.get("outlierFillColor")).append(),y>s&&
a.drawCircle((y-h)*b+l,f/2,d.get("spotRadius"),d.get("outlierLineColor"),d.get("outlierFillColor")).append());a.drawRect(g.round((p-h)*b+l),g.round(0.1*f),g.round((u-p)*b),g.round(0.8*f),d.get("boxLineColor"),d.get("boxFillColor")).append();a.drawLine(g.round((m-h)*b+l),g.round(f/2),g.round((p-h)*b+l),g.round(f/2),d.get("lineColor")).append();a.drawLine(g.round((m-h)*b+l),g.round(f/4),g.round((m-h)*b+l),g.round(f-f/4),d.get("whiskerColor")).append();a.drawLine(g.round((s-h)*b+l),g.round(f/2),g.round((u-
h)*b+l),g.round(f/2),d.get("lineColor")).append();a.drawLine(g.round((s-h)*b+l),g.round(f/4),g.round((s-h)*b+l),g.round(f-f/4),d.get("whiskerColor")).append();a.drawLine(g.round((r-h)*b+l),g.round(0.1*f),g.round((r-h)*b+l),g.round(0.9*f),d.get("medianColor")).append();d.get("target")&&(v=g.ceil(d.get("spotRadius")),a.drawLine(g.round((d.get("target")-h)*b+l),g.round(f/2-v),g.round((d.get("target")-h)*b+l),g.round(f/2+v),d.get("targetColor")).append(),a.drawLine(g.round((d.get("target")-h)*b+l-v),
g.round(f/2),g.round((d.get("target")-h)*b+l+v),g.round(f/2),d.get("targetColor")).append());a.render()}}});ca=s({init:function(a,b,c,d){this.target=a;this.id=b;this.type=c;this.args=d},append:function(){return this.target.appendShape(this),this}});E=s({_pxregex:/(\d+)(px)?\s*$/i,init:function(a,b,c){a&&(this.width=a,this.height=b,this.target=c,this.lastShapeId=null,c[0]&&(c=c[0]),h.data(c,"_jqs_vcanvas",this))},drawLine:function(a,b,c,d,e,f){return this.drawShape([[a,b],[c,d]],e,f)},drawShape:function(a,
